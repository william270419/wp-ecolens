...
**Versão 1.0.2** · [Código-fonte](wp-ecolens.php) · [Baixar pacote instalável](../wp-ecolens.zip) · [Histórico](CHANGELOG.md)
...
A versão 1.0.1 foi instalada e utilizada pelo autor, com relatos e capturas de auditorias e conteúdo sem imagens. A **1.0.2 contém funções novas ainda não validadas em uma instalação WordPress**. Confira o registro e o roteiro em [TESTES.md](TESTES.md).
...
Código distribuído sob [GPLv2](LICENSE).
